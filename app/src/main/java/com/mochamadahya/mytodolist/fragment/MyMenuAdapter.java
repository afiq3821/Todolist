...
class MyMenuAdapter extends RecyclerView.Adapter<MyMenuViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull MyMenuViewHolder myMenuViewHolder, int position) {
                // memasang data ke layout view holder
                myMenuViewHolder.txtmenuitem.setText(menu[position]);
                myMenuViewHolder.imgmenuitem.setImageResource(gambar[position]);
